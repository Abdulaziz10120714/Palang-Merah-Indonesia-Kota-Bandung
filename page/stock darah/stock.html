...
<html lang="en">
  <head>
    ...
    <script src="https://unpkg.com/feather-icons"></script>
     ...
     <!-- jumbotron -->
     <div class="mt-5 p-5 col-sm-12 banner-title d-flex">
      <div class="col-md-8 title-page ">
         <div class="lingkaran1 ms-5">
          <h1 style="font-family: 'Alex Brush'; font-size: 15vmin" >Stock</h1>
          <h1 class="ms-5" style="font-family: poppins; font-size: 6vmin;">Darah</h1> 
         </div>
      </div>
      <div class="col-md-4 image-banner">
        <img src="../../img/stock/1.jpg" alt="Foto Kegiatan" class="col-md-12 img-fluid">
      </div>
      <div class="col-md-12 gradient-banner">
      </div>
    </div>
    <div class="garis mt-0 p-0 text-white "  class="rounded float-end" style=" height: 25px; background:linear-gradient(to left, #084C61 , white)">
    </div>
    <!-- jumbotron end -->

    <!-- isi -->
    <div class="container my-5 fw-bold" >
      <div class="contain text-center" style="font-size: 6vmin">Stok Darah PMI Kota Bandung</div>
      <div class="container mt-5"><table class="table" style="font-size: 2vmin"> 
        <tr class="cont-satu text-center" >
          <td style="background-color: rgba(8, 76, 97, 0.5) !important;">NO</td>
          <td style="background-color: rgba(8, 76, 97, 0.5) !important;">Jenis golongan darah</td>
          <td style="background-color: rgba(8, 76, 97, 0.5) !important;">A+</td>
          <td style="background-color: rgba(8, 76, 97, 0.5) !important;">B+</td>
          <td style="background-color: rgba(8, 76, 97, 0.5) !important;">AB+</td>
          <td style="background-color: rgba(8, 76, 97, 0.5) !important;">O+</td>
        </tr>
        <tr>
          <td class="text-center">1</td>
          <td>THROMBOCYTE CONCENTARE (TC)</td>
          <td></td>
          <td></td>
          <td></td>
          <td></td>
        ...
        <tr>
          <td class="text-center" style="background-color: rgba(8, 76, 97, 0.1) !important;">2</td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;" >PACKED RED CELL (PRC)</td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
        </tr>
        ...
        <tr>
          <td class="text-center" style="background-color: rgba(8, 76, 97, 0.1) !important;">4</td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;">ANTI  HEMOPHILIC FACTOR (AHF)</td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
          <td style="background-color: rgba(8, 76, 97, 0.1) !important;"></td>
       ...
       <div class="container text-center my-5">-----  Terakhir Update : <span id="tanggalwaktu"></span></div>
    </div>
