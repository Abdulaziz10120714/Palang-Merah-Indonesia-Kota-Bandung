...
<div class="syarat container ">
    <div class="row">
        <div class="col-sm-6">
          <div class="atas container text-center">Syarat Donor Darah</div>
          <div class="bawah container p-5 text-white">Untuk Mendonorkan Darah Ada Syarat Seperti Berikut. Jika Sudah Sesuai Boleh Menekan Tombol Dibawah Ini.
          <a href="../auth/signup.html" class="btn btn-primary rounded-pill ">Lanjut</a>
          </div>
        </div>
        <div class="col-sm-6">
          <img src="./img/Group 156.png" class="img-fluid" alt="">
        </div>
    </div>
